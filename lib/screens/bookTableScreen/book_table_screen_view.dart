...
class BookScreenOverlay extends StatelessWidget {
  final Widget child;
  const BookScreenOverlay({super.key, required this.child});
  ...
  Widget _buildTimeRow(int startIndex, int endIndex) {
    return Row(
      ...
      children: List.generate(endIndex - startIndex, (index) {
        ...
        return Expanded(
          child: GestureDetector(
            onTap: () => controller.selectedTimeIndex.value = actualIndex,
            child: Container(
